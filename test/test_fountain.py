...
import src.widemd.fountain as parser
import utils
...
if sources is None:
    sources = utils.list_source_files(group, ".fountain.html")
...
def test_fountain(source_path):
    source, expected, options, parsed = utils.read_test_sources(group, source_path, parser, style)
