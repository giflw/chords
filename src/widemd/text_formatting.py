...
class Tag(Enum):
    CODE = r"`" # code
    I = r"_" # italic / emphasis # enable by semantics option
    # FIXME EM = r"_" # italic / emphasis
    MARK = r"=" # mark
    B = r"\*" # bold
    # FIXME STRONG = r"\*" # bold # enable by semantics option
    # https://www.w3schools.com/TAGS/tag_u.asp
    U = r"\+" # underline
    # FIXME INS = r"\+" # insert / underline # enable by semantics option
    # https://www.w3schools.com/TAGS/tag_s.asp
    S = r"\-" # strikethrough
    # FIXME DEL = r"\-" # delete / strikethrough # enable by semantics option
